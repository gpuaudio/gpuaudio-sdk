...
* cmake 3.26.3+
* git
* [GPU Audio Platform](https://www.gpu.audio/sdk-binaries) 2.3.0.219+
...
### NeuralAmpModeler and RT3S plugins deployment
...
### Use plugins with GPU acceleration in the DAW

* Ensure that `GPUAUDIO_PROCESSOR_PATH` contains the path to built processor DLLs
...
Models from this [repo](https://github.com/pelennor2170/NAM_models) may be used to quickly test the functionality and performance of NeuralAmpModeler
...
* Ensure that `GPUAUDIO_PROCESSOR_PATH` contains the path to built processor `.so` files. To achieve this you may use `launchctl setenv GPUAUDIO_PROCESSOR_PATH path_to_sdk/@BUILD/bin/RelWithDebInfo` and restart the DAW
...
Models from this [repo](https://github.com/pelennor2170/NAM_models) may be used to quickly test the functionality and performance of NAM
